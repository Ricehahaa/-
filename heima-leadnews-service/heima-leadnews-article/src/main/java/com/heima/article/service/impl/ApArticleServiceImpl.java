...
import com.heima.model.article.pojos.HotArticleVo;
    ...
    public ResponseResult collection(CollectionBehaviorDto dto) {
        ...
        if(dto.getOperation() == 0){
            ...
            apCollectionMapper.delete(Wrappers.<ApCollection>lambdaQuery().
                    eq(ApCollection::getArticleId, apCollection.getArticleId())
                    .eq(ApCollection::getEntryId, apCollection.getEntryId())
                    .eq(ApCollection::getType, 3));
        } else {
